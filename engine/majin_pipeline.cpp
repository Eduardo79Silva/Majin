...
MajinPipeline::~MajinPipeline() {
  vkDestroyShaderModule(_majinDevice.device(), _vertShaderModule, nullptr);
  vkDestroyShaderModule(_majinDevice.device(), _fragShaderModule, nullptr);
  vkDestroyPipeline(_majinDevice.device(), _graphicsPipeline, nullptr);
}
...
void MajinPipeline::bind(VkCommandBuffer commandBuffer) {
...
void MajinPipeline::createGraphicsPipeline(
  ...
  auto bindingDescriptions = MajinModel::Vertex::getBindingDescriptions();
  auto attributeDescriptions = MajinModel::Vertex::getAttributeDescriptions();
  ...
  if (vkCreateGraphicsPipelines(_majinDevice.device(), VK_NULL_HANDLE, 1,
...
void MajinPipeline::defaultPipelineConfigInfo(PipelineConfigInfo &configInfo,
