...
VkResult MajinSwapChain::acquireNextImage(uint32_t *imageIndex) {
...
VkResult MajinSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers,
                                              uint32_t *imageIndex) {
...
void MajinSwapChain::createSwapChain() {
...
void MajinSwapChain::createImageViews() {
...
void MajinSwapChain::createRenderPass() {
...
void MajinSwapChain::createFramebuffers() {
...
void MajinSwapChain::createSyncObjects() {
...
VkSurfaceFormatKHR MajinSwapChain::chooseSwapSurfaceFormat(
...
VkExtent2D
MajinSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat MajinSwapChain::findDepthFormat() {
